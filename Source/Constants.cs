namespace PawnVarianceMod
{
    public static class Constants
    {
        ...
        // floor applied after the fact
        public const float MagnitudeLerpLow = 0f;
        public const float MaxMagnitude = 6f;
        // Small ±0.25 jitter ((Rand.Value - 0.5f) * 0.5f) used by TraitVarianceApplier to smooth
        // integer boundary rounding on quality-lerped trait counts. Not a trait noise knob.
